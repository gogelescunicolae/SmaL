...
import com.example.fragmentapp.firebase.Upload;
...
public class ProfileFirebase extends AppCompatActivity {
    ...
    private Button mButtonUpload,log;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        log=findViewById(R.id.logout_btn1);
        ...
        log.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.apply();
                Intent i=new Intent(ProfileFirebase.this,login_act.class);
                startActivity(i);
                finish();
            ...
            mUploadTask = fileReference.putFile(mImageUri)
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(ProfileFirebase.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    })
